                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div style="color: red; margin: 2.5% auto; line-height: 20px;" class=""></div>
                                    <form class="user" method="post" action="<?php echo DIRPAGE . 'controllers/controllerLogin'; ?>" id="formLogin">
                                        ...
                                        <div class="form-group">
                                        	<input class="form-control form-control-user" type="password" placeholder="********" id="senha"  name="password">
                                        </div>
