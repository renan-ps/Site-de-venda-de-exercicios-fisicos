							...
							<div class="p-5">
								...
								<form class="user form-login" method="post"
									...
									<div class="form-group">
										<input class="form-control form-control-user" type="email" placeholder="E-mail" id="email"
										       name="email">
									</div>

									<div class="form-group">
										<input class="form-control form-control-user" type="password" placeholder="********" id="senha"
										       name="senha">
									</div>
									...
									<button class="btn btn-primary btn-block text-white btn-user" type="submit" value="Entrar">Entrar
									</button>
									<hr>
									<a class="btn btn-primary btn-block text-white btn-google btn-user" role="button">
										<i class="fab fa-google"></i>&nbsp; Entrar com Google</a><a
										class="btn btn-primary btn-block text-white btn-facebook btn-user" role="button">
