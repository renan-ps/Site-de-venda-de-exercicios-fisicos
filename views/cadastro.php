					...
					<div class="p-2">
						...
						<form class="user" method="post" name="formCadastro" id="formCadastro"
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input class="form-control form-control-user" type="email" id="email" placeholder="E-mail"
									       name="email">
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input class="form-control form-control-user" type="text" id="telefone" placeholder="Telefone"
									       name="telefone">
								</div>
