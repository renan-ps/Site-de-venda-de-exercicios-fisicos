        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-3">
                    <div class="col-lg-4">
                        <div class="card mb-3">
                            <div class="card-body text-center shadow" style="height: 318px;"><img class="rounded-circle mb-3 mt-4" src="../../images/dogs/image2.jpeg?h=a0a7d00bcd8e4f84f4d8ce636a8f94d4" width="160" height="160">
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group"><label for="address"><strong>Senha Atual</strong><br></label><input class="form-control" type="text" name="address"></div>
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group"><label for="country"><strong>Nova Senha</strong><br></label><input class="form-control" type="text" name="country"></div>
