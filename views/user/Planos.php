...
<head>
  ...
  <link rel="stylesheet" href="../../lib/css/user/bootstrap.min.css?h=504792f7254b7c7ba831bdd93d286139">
    ...
    <link rel="stylesheet" href="../../lib/css/user/clean-responsive-pricing.css?h=03147876505551d80bce125ae9d141b1">
</head>
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                <div class="nav-item dropdown no-arrow"><button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button"><span class="d-none d-lg-inline mr-2 text-gray-600 small">Valerie Luna</span><img class="border rounded-circle img-profile" src="assets/img/avatars/avatar1.jpeg?h=0ecc82101fb9a10ca459432faa8c0656"></button>
                                    <div
