...
class ClassLogin extends ClassCrud{
    ...
    #Conta as tentativas de login mal sucedidas
    ...
    #Insere as tentativas de login mal sucedidas no banco de dados
    ...
    #Apaga as tentativas de login mal sucedidas no banco de dados
