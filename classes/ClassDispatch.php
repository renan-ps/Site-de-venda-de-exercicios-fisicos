...
class ClassDispatch{
    ...
    //Verifica se o índice digitado pelo usuário é realmente um diretório
    ...
    //Verifica se existe o arquivo requisado. Se não existir, ele chama o index.php, se não, chama a página 404.
    ...
    //Retornar a página final para o usuário.
